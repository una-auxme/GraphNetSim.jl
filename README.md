...
[![Build Status](https://github.com/JoKircher/GraphNetSim.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/JoKircher/GraphNetSim.jl/actions/workflows/CI.yml?query=branch%3Amain)
